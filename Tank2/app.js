...
var GameField = /** @class */ (function (_super) {
    ...
    GameField.prototype.doMove = function (side, tankID, action) {
        ...
        tl.fromTo(tank, 0.5, { x: tank.c, y: tank.r, moveProgress: 0 }, { x: tank.c + Util.dx[dir], y: tank.r + Util.dy[dir], moveProgress: 1, ease: Linear.easeNone, immediateRender: false });
...
var Indicator = /** @class */ (function (_super) {
    ...
    function Indicator() {
        ...
        _this.lineStyle(Indicator.THICKNESS, Colors.GREEN, 0.5);
    ...
    function TankGame() {
        ...
        infoProvider.v2.setDisplayCallback(function (d) {
            ...
            if (d.loseReason) {
                reasons = d.loseReason.map(function (reason, i) {
                    ...
                    if (reason == "INVALID_INPUT_VERDICT_OK") {
                        var validateResult = _this.field.validateAction(i, 0, d[i][0]) ||
                            _this.field.validateAction(i, 1, d[i][1]);
            ...
            _this.field.eachAliveTank(function (tank) {
                var action = d[tank.side] && d[tank.side][tank.tank];
            ...
            _this.field.eachAliveTank(function (tank) {
                ...
                if (typeof action === "number" && action >= Action.UpShoot) {
                    tl.add(_this.field.doShoot(tank.side, tank.tank, action, [d[0], d[1]]), 0);
                    DOM.playSound(DOM.elements.shootSound, tl, 0);
                }
            });
            tl.add(_this.field.finalize());
            _this.field.lastActions = [d[0], d[1]];
            if (reasons) {
